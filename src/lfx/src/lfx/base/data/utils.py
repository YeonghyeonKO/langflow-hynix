...
def extract_text_from_bytes(file_name: str, file_content: bytes, *, employee_id: str | None = None) -> str:
        ...
        try:
            ...
            try:
                ...
                result = subprocess.run(  # noqa: S603, PLW1510
                    ["antiword", tmp_path], capture_output=True, text=True, timeout=30  # noqa: S607
                )
    ...
    if lower_name.endswith(".xlsx"):
        try:
            ...
            MAX_ROWS = 10_000  # noqa: N806  # OOM prevention (~5MB text output max)
    ...
    if lower_name.endswith(".xls"):
        try:
            ...
            MAX_ROWS = 10_000  # noqa: N806  # OOM prevention
    ...
    if lower_name.endswith(".csv"):
        MAX_LINES = 10_000  # noqa: N806  # OOM prevention
